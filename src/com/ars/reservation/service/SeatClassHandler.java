...
public class SeatClassHandler extends CommonView
{
    ...
    private Airline selectFlight(List<Airline> airlineInfos)
    {
        for (Airline airlineInfo : airlineInfos)
        {
            if (airlineInfo.getDepartAirport().equals(ticket.getDepartAirport())
                ...
                && airlineInfo.getDepartTime().equals(ticket.getDepartTime()))
            {
    ...
    private void selectSeatClass(Airline airlineInfos)
    {
        ...
        println("2. Business Class (" + airlineInfos.getBusinessPrice() + " Yuan)");
        println("3. Economy Class (" + airlineInfos.getEconomicPrice() + " Yuan)");
